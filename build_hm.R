...
#'
#' @param mu Drift rate used to generate the heatmap
#' @param sigma Within-trial noise
#' @param dt Time resolution
#' @param ev_bound Determines the evidence range generated, which is [-ev_bound, ev_bound]
#' @param ev_window Evidence resolution
#' @param upperRT Max RT generated
#'
#' @return
#' @export
#'
